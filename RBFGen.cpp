...
int crazyfunc(int mval){
    string mycountstr = to_string(mval+1);
...
//Initializing RBF data structure, bigr is the variable name of the RBF array
    vector< vector<int>> bigr(2, vector<int> (mval));
    // int bigr[2][mval] ;
    int mycount = 0;
    for(int i=0;i<1;++i){
...
//    cout<<endl;
    ...
    int storehashnum[8];
//Generating 10000 ip addresses and embedding into RBF
...
//            cout<<hashnumval<<" *";
            ...
            int plusorminus = crazyfunc(hashnumval);
//            cout<<plusorminus<<"**";
            if(bigr[plusorminus][hashnumval] ==0){
                bigr[plusorminus][hashnumval] = 1;
                bigr[1-plusorminus][hashnumval] = 0;
            }
...
//            int rbfhashmod = abs(rbfhashint % 2);
//            if(rbfhashmod == 0){
//                chosenarray[j] = bigr[0][j];
//            }
//            else if (rbfhashmod == 1){
//                chosenarray[j] = bigr[1][j];
//            }
//
////            bigr[i][j] = mycount;
//        }
...
//Saving RBF into the text file
        ofstream myfile("RBFRow1.txt");
        if (myfile.is_open()) {
//        cout<<"Im in file";
            for (int count = 0; count < mval; count++) {
                myfile << bigr[0][count] << " ";
            }
            myfile.close();
